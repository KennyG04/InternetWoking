...
# ==========================================
resource "eveng_lab" "lab_mpls_risco" {
  name        = "Topologia_MPLS_Risco"
  description = "Laboratorio MPLS - VRF Risco"
}

resource "eveng_network" "cloud_gestion" {
  lab_path = eveng_lab.lab_mpls_risco.path
...
# ==========================================
# NOTA: Cambia el valor de "image" por el nombre exacto de tu archivo .bin en EVE-NG
...
# ==========================================
# 5. ENLACES DE DATOS (Mapeo exacto)
# ==========================================
